...
<meta name="keywords" content="挂靠,挂靠网,一级建造师挂靠,二级建造师挂靠,建造师挂靠,证书挂靠网,证书挂靠"/>
<meta name="description" content="112挂靠网提供一级建造师挂靠、二级建造师挂靠、注册造价师挂靠、建筑师、结构师、监理工程师挂靠等信息发布平台，为您提供安全保障的快捷挂靠！"/>
 ...
 <div id="xq"> 
    <div class="z" style="font-weight: 800;padding-left: 10px;margin:10px;"> 
     <a href="#"><img src="${path}/static/image/06a26f17654f1ff776df44de0cbc3fcd.jpg"/></a> 
    </div>
 </div>
 <div id="xq"> 
    <div class="z" style="font-weight: 800;padding-left: 10px;margin:10px;"> 
     <a href="#"><img src="${path}/static/image/AD-3.jpg"/></a> 
    </div>
 </div>
 <%@ include file="/WEB-INF/inc/guakao/gkindex.jsp"%>
