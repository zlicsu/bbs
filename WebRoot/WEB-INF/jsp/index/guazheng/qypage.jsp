     ...
     <div class="mn"> 
           ...
           <tr class="ts"> 
            <th colspan="6">
             <div class="separatorlinediv cl">
              <a href="javascript:;" title="查看更新" class="forumrefresh">企业列表</a>
             </div></th> 
           </tr> 
          </tbody>
                        ...
                        <td class="t">
                            <span style="margin-right: 10px;">
                                <input type="checkbox" name="idli" value="60110" /></span> <a style="font-size: 14px;"
                                    href="#" target="_blank">
                                    ${company.name}</a> <span class="icoSmsTel1" title="手机已验证"></span>
                        </td>
                        <td class="tc">
                           	${company.zsname}&nbsp;
                            <span>&nbsp;</span>
      ...
      <div class="bm bw0 pgs cl"> 
       ...
       <span>当前第${page.pagestart}页/总${page.totalPages}页</span>
        ...
        <a href="${path}/guakao/qiye/querypage.do?pagestart=1" >首页</a>
        <a href="${path}/guakao/qiye/querypage.do?pagestart=${page.pagestart-1}" >上一页</a>
        </c:if>
	         <strong>${page.pagestart}</strong>
         <c:if test="${page.pagestart!=page.totalPages}">
         <a href="${path}/guakao/qiye/querypage.do?pagestart=${page.pagestart+1}" >下一页</a>
        <a href="${path}/guakao/qiye/querypage.do?pagestart=${page.totalPages}" >末页</a>
         </c:if>
        </div>
      </div>
     </div> 
